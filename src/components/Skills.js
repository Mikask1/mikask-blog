...
const ProgressGrid = () => {
    return (
        <div className='progress-grid grid grid-cols-2 pt-10'>
            ...
            <ProgressBar text='C' color='#6f82e9' value="21" dataAos="slide-left" data-aos-delay="1000"><CIcon /></ProgressBar>
            <ProgressBar text='Google' color='#4285F4' value="420" dataAos="slide-right"><GoogleIcon/></ProgressBar>
        </div>
    )
}
...
function ProgressBar(props){
    ...
    function updateBar() {
        const progressUpdate = sliderRef.current.value + '%'
